              ...
              <div className="max-w-3xl shadow-lg rounded-lg mx-auto">
                ...
                <div className="bg-gray-100 dark:bg-gray-900 rounded-b-lg p-4 flex flex-col items-end leading-normal">
                  <div className="mb-8 -space-y-2">
                    ...
                    <div className="flex-flex-col items-center text-base text-justify space-y-1 w-full h-full normal-case px-3 pt-5 md:pt-8" dangerouslySetInnerHTML={{ __html: post.content.html}} />
