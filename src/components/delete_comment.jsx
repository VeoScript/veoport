...
export default function DeleteComment({ online_user, commentId }) {
  ...
  async function handleDeleteComment() {
    ...
    await fetch('/api/comment/delete_comment', {
      method: 'DELETE',
      headers: {
  ...
  return (
    <>
      <button
        ...
        onClick={openModal}
      >
        <svg className="w-4 h-4 fill-current text-[#333] dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <div className="min-h-screen px-4 text-center bg-black bg-opacity-50">
            ...
            >
              <div className="inline-block w-full max-w-sm p-6 my-8 overflow-hidden align-middle text-left transition-all transform text-[#333] dark:text-white bg-white dark:bg-[#232733] shadow-xl rounded-2xl">
                ...
                >
                  <span className="font-bold text-lg">Delete comment</span>
                  <button
                    type="button"
                ...
                <div className="flex flex-col w-full mt-4">
                  <span className="font-normal text-[#333] dark:text-gray-200">Delete your comment permanently?</span>
