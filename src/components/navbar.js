    ...
    <nav className="fixed bottom-0 mx-auto w-full z-50 bg-gray-100 border-t-2 border-gray-300 dark:border-gray-700 dark:bg-[#2C3141]">
      ...
      <div className="flex md:hidden justify-around shadow-sm bg-gray-50 dark:bg-[#2C3141]">
        <ul className="flex flex-row w-full justify-around items-center">
          <li data-tooltip="Home" className={`flex justify-center py-3 w-full ${router.pathname == '/' ? 'bg-gray-200 dark:bg-gray-900'  : "bg-gray-50 dark:bg-[#2C3141]"}`}>
            <Link href="/">
              <a>
          ...
          <li data-tooltip="Portfolio" className={`flex justify-center py-3 w-full ${router.pathname == '/portfolio' ? 'bg-gray-200 dark:bg-gray-900'  : "bg-gray-50 dark:bg-[#2C3141]"}`}>
            <Link href="/portfolio">
              <a>
          ...
          <li data-tooltip="Contact" className={`flex justify-center py-3 w-full ${router.pathname == '/contact' ? 'bg-gray-200 dark:bg-gray-900'  : "bg-gray-50 dark:bg-[#2C3141]"}`}>
            <Link href="/contact">
              <a>
          ...
          <li data-tooltip="Others" className={`flex justify-center py-3 w-full ${router.pathname == '/others' ? 'bg-gray-200 dark:bg-gray-900'  : "bg-gray-50 dark:bg-[#2C3141]"}`}>
            <Link href="/others">
              <a>
