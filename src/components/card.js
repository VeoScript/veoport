...
export default function Card({ article }) {
  return (
    <div className="flex flex-col justify-center w-full rounded-lg bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex flex-row items-center justify-between p-3">
        <div className="flex flex-col">
          ...
          <p className="font-semibold text-sm text-gray-500 uppercase">{article.category.name}</p>
        </div>
