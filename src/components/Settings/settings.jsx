...
export default function Settings({ online_user }) {
      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-4 text-center bg-black bg-opacity-50">
            ...
            >
              <div className="inline-block w-full max-w-xl p-6 my-8 overflow-hidden align-middle text-left transition-all transform text-[#333] dark:text-white bg-white dark:bg-[#232733] shadow-xl rounded-2xl">
                <Dialog.Title
                  as="h1"
