...
export default function Navbar() {
  ...
  return (
    <nav className="fixed bottom-0 mx-auto w-full max-w-[2400px] z-20 bg-gray-100 border-t-2 border-gray-300 dark:border-gray-700 dark:bg-[#2C3141]">
      ...
      <div className="flex md:hidden justify-around shadow-sm bg-gray-50 dark:bg-[#2C3141]">
        <ul className="flex flex-row w-full justify-around items-center">
          ...
          <li className={`flex justify-center py-3 w-full ${router.pathname == '/blog' ? 'bg-gray-200 dark:bg-gray-900'  : "bg-gray-50 dark:bg-[#2C3141]"}`}>
            <Link href="/blog">
              <a>
